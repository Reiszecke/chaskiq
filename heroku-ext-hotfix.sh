...
bundle exec rake pg:psql -a $HEROKU_APP_NAME -c 'create extension if not exists citext schema heroku_ext'
bundle exec rake pg:psql -a $HEROKU_APP_NAME -c 'create extension if not exists pg_stat_statements schema heroku_ext'
